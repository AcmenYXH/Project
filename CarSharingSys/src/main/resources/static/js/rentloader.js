...
<!-- 百度地图js -->
document.write('<script type="text/javascript" src="http://api.map.baidu.com/api?v=3.0&ak=E0wKA0gRCRdmNTfsjA49shTqFAf1bW21"></script>');
<!-- 时间格式 -->
document.write('<script src="'+getRootPath()+'/js/datetimeformat.js"></script>');
<!-- 天气 -->
//document.write('<script src="'+getRootPath()+'/js/weather.js"></script>');
//自定义js
